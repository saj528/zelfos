...
public class PotionShop implements Entity, Collidable {
    ...
    public PotionShop(float x, float y, Player player, CoinManager coinManager, EntityManager entityManager, CollisionManager collisionManager, WaveManager waveManager) {
        this.x = x;
        this.y = y;
